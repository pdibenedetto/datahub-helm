...
━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
prerequisites-        postgres-password    StatefulSet/        PostgreSQL admin/DataHub DB password. DataHub is using this via your override to
postgresql                                 prerequisites-      global.sql.datasource.password.secretRef=prerequisites-postgresql.
postgresql,
Deployment/
datahub-datahub-
gms, Job/
...
update
──────────────────  ─────────────────────  ──────────────────  ────────────────────────────────────────────────────────────────────────────────────────────────────
prerequisites-      controller-password    StatefulSet/        Kafka controller SASL password. DataHub clients are not using Kafka auth here.
kafka-user-                                prerequisites-
passwords                                  kafka-
controller,
Kafka init
container
──────────────────  ─────────────────────  ──────────────────  ────────────────────────────────────────────────────────────────────────────────────────────────────
prerequisites-         kraft-cluster-id    StatefulSet/        Stored as a Secret, but this is a Kafka KRaft cluster identifier, not really a credential.
kafka-kraft-                               prerequisites-
cluster-id                                 kafka-controller

Elasticsearch is deployed, but I found no deployed Elasticsearch credential Secret or workload secret refs. It is running over HTTP without auth in this install.

DataHub

Secret                           Key    Used by                                                       Notes                                                       
━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
datahub-auth-       system_client_se    datahub-gms, datahub-frontend, acryl-datahub-actions,         Internal DataHub system client secret. Auto-generated by
secrets                         cret    datahub-system-update                                         the chart hook.
──────────────────  ──────────────────  ────────────────────────────────────────────────────────────  ─────────────────────────────────────────────────────────────
datahub-auth-       token_service_si    datahub-gms, datahub-system-update                            JWT/token signing key. Auto-generated by the chart hook.
secrets                    gning_key
──────────────────  ──────────────────  ────────────────────────────────────────────────────────────  ─────────────────────────────────────────────────────────────
datahub-auth-       token_service_sa    datahub-gms, datahub-system-update                            JWT/token salt. Auto-generated by the chart hook.
secrets                           lt
──────────────────  ──────────────────  ────────────────────────────────────────────────────────────  ─────────────────────────────────────────────────────────────
datahub-            encryption_key_s    datahub-gms                                                   DataHub secret-service encryption key for managed
encryption-                    ecret                                                                  ingestion/secrets. Auto-generated by the chart hook.
secrets
──────────────────  ──────────────────  ────────────────────────────────────────────────────────────  ─────────────────────────────────────────────────────────────
datahub-gms-        datahub.gms.secr    datahub-frontend                                              Frontend/GMS shared app secret. Generated by the frontend
secret                            et                                                                  subchart.
──────────────────  ──────────────────  ────────────────────────────────────────────────────────────  ─────────────────────────────────────────────────────────────
ironbank-pull-      .dockerconfigjso    DataHub workloads via imagePullSecrets                        Not created by Helm, but referenced by your DataHub Helm
secret                             n                                                                  values for pulling IronBank images.

Not Deployed / Not Active

- datahub-ingestion-cron: no CronJobs exist in datahub-test, so it has no deployed credential references right now.
- datahub-frontend.defaultUserCredentials: {} in computed values, so no datahub-user-secret was created.
- MySQL, Neo4j, OpenSearch prereqs are disabled. Their values contain credential placeholders/defaults, but no deployed resources or Secrets from this install.
- sh.helm.release.v1.* Secrets exist, but those are Helm release metadata, not application credentials.
